...
public class Sistem {
    ...
    // main utama
    public static void Sistem() throws IOException{
        // data ArrayList
        barangMahasiswa.add(new BarangMahasiswa("Jaka", 232342, "Helm", "Merah", "Padat",1, "21.09"));
...
//        barang.get(0).harga_Penitipan = 15000;
        barangMahasiswa.add(new BarangMahasiswa("Yaya", 21001, "Tas", "Putih", "Padat",1, "07.23"));
...
//        barang.get(1).harga_Penitipan = 15000;
        barangMahasiswa.add(new BarangMahasiswa("Reni", 21002,"Buku", "Orange", "Padat", 5,"09.25"));
...
//        barang.get(2).harga_Penitipan = 15000;
        barangDosen.add(new BarangDosen("Supri", 409080, "Kunci Motor", "Hitam", "Besi", 1, "08.15"));
    ...
    public final static void menuLihat() throws IOException{
        InputStreamReader input = new InputStreamReader(System.in);
        BufferedReader pilih = new BufferedReader(input);
        System.out.println("|---------------------------------------|");
    ...
    public final static void menuTambah() throws IOException{
        InputStreamReader input = new InputStreamReader(System.in);
        BufferedReader pilih = new BufferedReader(input);
        System.out.println("|---------------------------------------|");
        System.out.println("|           Pilih Pemilik Barang        |");
    ...
    public static void tambahBarangMahasiswa() throws IOException{
        ...
        // add ke ArrarList
        BarangMahasiswa databaru = new BarangMahasiswa(nama_mahasiswa, nim, nama_barang, warna_barang, jenis_barang, banyak_barang, waktu_serah);
...
//        databaru.harga_Penitipan = harga_Penitipan;
    ...
    public static void tambahBarangDosen() throws IOException{
        ...
        // add ke ArrarList
        BarangDosen databaru = new BarangDosen(nama_dosen, nip, nama_barang, warna_barang, jenis_barang, banyak_barang, waktu_serah);
//        databaru.nama_Penitip = nama_Penitip;
//        databaru.nama_Barang = nama_Barang;
//        databaru.waktu_Serah = waktu_Serah;
//        databaru.harga_Penitipan = harga_Penitipan;
    ...
    public final static void menuUpdate() throws IOException{
        InputStreamReader input = new InputStreamReader(System.in);
        BufferedReader pilih = new BufferedReader(input);
        System.out.println("|---------------------------------------|");
        System.out.println("|           Pilih Pemilik Barang        |");
...
//        harga_penitipan = Integer.parseInt(baru.readLine());
    ...
    public final static void menuDelete() throws IOException{
        InputStreamReader input = new InputStreamReader(System.in);
        BufferedReader pilih = new BufferedReader(input);
        System.out.println("|---------------------------------------|");
        System.out.println("|           Pilih Pemilik Barang        |");
    ...
    public final static void cekHarga() throws IOException{
        InputStreamReader input = new InputStreamReader(System.in);
        BufferedReader pilih = new BufferedReader(input);
        System.out.println("|---------------------------------------|");
        System.out.println("|           Pilih Pemilik Barang        |");
